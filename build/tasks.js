...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var PORT, middleware, dbClient, routes, app;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dotenv.config({ path: __dirname + "/../.env" });
                    PORT = 3000 || process.env.TASK_PORT;
                    middleware = jwt_1.default(logger_1.default);
                    return [4 /*yield*/, dbClient_1.default(logger_1.default)];
                case 1:
                    dbClient = _a.sent();
                    routes = index_1.default(logger_1.default, dbClient);
